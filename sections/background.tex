...
In this thesis, we use two different aspects of ambiguity:
\begin{itemize}
...
\end{itemize}
One word can have both general and gender ambiguity, as well as only one or the other or neither.
