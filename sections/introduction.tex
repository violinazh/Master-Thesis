...
\begin{itemize}
    \item \textbf{Subquestion 1:} How diverse are translations? % inspecting diversity patterns in translations which could point to ambiguity
    \item \textbf{Subquestion 2:} How do ambiguous and non-ambiguous words influence the diversity in translation? % inspecting diversity patterns in translations which could point to ambiguity
    
    % TODO: Should modify these questions
